...
Read the research strategy principles at `${CLAUDE_PLUGIN_ROOT}/principles/research-strategy.md`. Pay special attention to RS2 (The Conclusion-First Test) and RS3 (The Nugget Test).
